export default {
  ...
  <div>
    ...
    ## Name
    Each component must define a name. This is is the string you will use to render components using the [~~\{\{component\}\}~~](#component/helpers) helper within your template.
    ...
    ## Methods
    Methods defined in a component are avalable for use with the [~~{{method}}~~](#components/methods) helper, or can be called from within another method.
